<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Add new category</h2>
    </x-slot>
            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <fieldset class="p-5 border rounded-xl">
                        <legend class="p-2 text-lg font-bold">Add new category</legend>
                        {{-- @if ($errors->any())
                            <div>
                                <ul>
                        ...
                        <form method="POST" action="{{ route('category.store') }}">
                            ...
                            <div class="grid w-full grid-cols-2 gap-4">
                                ...
                                <div class="w-full">
                                    <x-input-label>main category</x-input-label>
