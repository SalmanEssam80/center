            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-end">
                        <x-primary-link href="{{ route('classRooms.create') }}">Add new Class Room</x-primary-button>
                    </div>
                      <!-- component -->
                      <div class="p-5">
                    ...
                    <form action="{{ route('classRooms.index') }}">
                        <div class="flex justify-evenly">
                            <div>
                                <x-input-label for='Search By Name'>Search By Name Or capacity</x-input-label>
                                        ...
                                        <tbody>
                                            @forelse ($classRooms as $key => $classRoom)
                                                <tr class="bg-gray-100 border-b">
                                                    ...
                                                    <td
                                                        class="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap">
                                                        {{ date_format(date_create($classRoom->created_at), 'Y-m-d h:i:s a') }}
                                                    </td>
                                                    <td
                                                        class="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap">
                                                        <div class="flex justify-evenly">
                                            ...
                                            @empty
                                                <td colspan='6' class="text-center bg-gray-100 border-b">
                                                    NO DATA YET
                                                </td>
                                            @endforelse
                                        </tbody>
